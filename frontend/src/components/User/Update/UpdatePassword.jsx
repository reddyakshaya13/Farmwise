...
const UpdatePassword = () => {
    ...
    return (
        <>
            <MetaData title="Change Password • Farmwise" />
            ...
            <form onSubmit={handlePasswordUpdate} className="flex flex-col gap-4 py-8 px-16 sm:w-3/4">
                ...
                <button type="submit" disabled={loading} className="bg-forest-green font-medium rounded text-white py-2 w-40 mx-auto text-sm">Change Password</button>
            </form>
        </>
    )
}
