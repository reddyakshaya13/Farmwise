...
const UpdateProfile = () => {
    ...
    return (
        <>
            <MetaData title="Edit Profile • Farmwise" />
            ...
            >
                ...
                <button type="submit" disabled={loading} className="bg-forest-green font-medium rounded text-white py-2 w-40 mx-auto text-sm">Submit</button>
            </form>
        </>
    )
}
